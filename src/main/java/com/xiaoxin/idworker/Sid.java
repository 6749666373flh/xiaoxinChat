...
import com.xiaoxin.idworker.strategy.DefaultWorkerIdStrategy;
import com.xiaoxin.idworker.utils.Utils;
...
@Component
public class Sid {
    private static com.xiaoxin.idworker.WorkerIdStrategy workerIdStrategy;
    ...
    public static synchronized void configure(com.xiaoxin.idworker.WorkerIdStrategy custom) {
